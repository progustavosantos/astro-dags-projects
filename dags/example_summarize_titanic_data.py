...
default_args={
    "owner": "Renan Klotz,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-02-20", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Renan Klotz": "mailto:klotzrenan@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clstywrjz000e01nylj0nbrh0/cloud-ide/clstz7co6001q01msw4m9euyp/clstz7cyt000n01nyxvm6o4q9",
    },
)
